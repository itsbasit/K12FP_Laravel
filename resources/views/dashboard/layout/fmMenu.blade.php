<div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item">
        <a href="{{url('fm/fund-raisers')}}" class="nav-link">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="#students" role="button" aria-expanded="" aria-controls="email">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="#invite" role="button" aria-expanded="" aria-controls="email">
          <i class="link-icon" data-feather="file-text"></i>
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="collapse" href="#payment" role="button" aria-expanded="" aria-controls="email">
          <i class="link-icon" data-feather="file-text"></i>
