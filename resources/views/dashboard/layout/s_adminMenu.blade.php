<div class="sidebar-body">
    <ul class="nav">
        ...
        <li
            class="nav-item {{ request()->is('admin/states','admin/counties','admin/districts','admin/schools') ? 'active' : '' }}">
            <a class="nav-link" data-toggle="collapse" href="#email" role="button" aria-expanded=""
                aria-controls="email">
                <i class="link-icon" data-feather="mail"></i>
                <span class="link-title">Schools Data</span>
                <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse {{ request()->is('admin/states','admin/import','admin/counties','admin/districts','admin/schools') ? 'show' : '' }}"
                id="email">
                <ul class="nav sub-menu ">
                    <li class="nav-item">
                        <a href="{{url('admin/import')}}"
                            class="nav-link {{ request()->is('admin/import','admin/import') ? 'active' : '' }}">Bulk
                            Import</a>
                    </li>

                    <li class="nav-item">
                        <a href="{{url('admin/states')}}"
                            class="nav-link {{ request()->is('admin/states','admin/states/*') ? 'active' : '' }}">States</a>
                    </li>

                    <li class="nav-item">
                        <a href="{{url('admin/counties')}}"
                            class="nav-link {{ request()->is('admin/counties','admin/counties/*') ? 'active' : '' }}">Counties</a>
                    </li>

                    <li class="nav-item">
                        <a href="{{url('admin/districts')}}"
                            class="nav-link {{ request()->is('admin/districts','admin/districts/*') ? 'active' : '' }}">Districts</a>
                    </li>

                    <li class="nav-item">
                        <a href="{{url('admin/schools')}}"
                            class="nav-link {{ request()->is('admin/schools','admin/schools/*') ? 'active' : '' }}">Schools</a>
                    </li>
                </ul>
            </div>
        </li>
