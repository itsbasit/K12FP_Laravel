    ...
    <div class="col-md-12 grid-margin">
      <div class="card">
        <div class="card-body">
            ...
            <form id="addSchool" class="forms-sample" method="POST" action="{{route('schools.store')}}">
            <h4 class="mb-5">Add New School</h4>
            @csrf
              ...
              <div class="col-md-6 offset-md-3">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <input name="schoolName" class="form-control mb-4 mb-md-0" placeholder="Enter School Name">
                  </div>
