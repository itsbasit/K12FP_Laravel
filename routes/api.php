...
Route::post('create-payment', function () {
    $apiContext = new \PayPal\Rest\ApiContext(
        new \PayPal\Auth\OAuthTokenCredential(
            'AWha3XwZPWaNM_fRthFHxXEc2xoc_81RZvzDSWqbajbbfq3oSCgvp2bHPBLytkecGe1bfIdr1Jwwxp85',
            'EH-UbJbfmJUgyIkTqln-g6jvJDSprOtQ1HjxskkAzzGo7fUhtm5M17zOePCljITj8dnOBHhw1yaMgj05'      // ClientSecret
        )
    );
